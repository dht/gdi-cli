...
const patchConfig = (enabled) => {
    ...
    fs.writeJSONSync(configPath, {
        enabled: Object.assign(Object.assign({}, config.enabled), enabled),
    }, { spaces: 4 });
};
...
const enable = (collectionId) => {
    ...
    console.log(chalk.magenta('enabling collection ') + chalk.grey(collectionId));
...
const disable = (collectionId) => {
    ...
    console.log(chalk.magenta('disabling collection ') + chalk.grey(collectionId));
