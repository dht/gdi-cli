...
const preRun = () => (command, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let template = 'package', outputDir = `${cwd}/${entityName}`;
    ...
    command.local.rulesReplaceContent = {
        '\\$PACKAGE_NAME_CAPITAL': ({ entityName }) => cases_1.default.upperFirst(entityName),
        '\\$PACKAGE_NAME': ({ entityName }) => cases_1.default.lowerCase(entityName),
    };
    next();
});
